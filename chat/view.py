...
CLOSING_PROTOCOL = "WM DELETE WINDOW"
END_OF_LINE = "\n"
KEY_RETURN = "<Return>"
...
class EzChatUI(object):
    ...
    def __init__(self, application):
        ...
        self.gui = None  # Toplevel widget of Tk which represents mostly the main window of an application. It has an associated Tcl interpreter."""
        self.frame = None  # Frame widget which may contain other widgets and can have a 3D border
    ...
    def input_dialogs(self):
        ...
        if self.application.port is None: return False
        return True
